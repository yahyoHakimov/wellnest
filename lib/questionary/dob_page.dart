...
class DobPage extends StatelessWidget {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            Expanded(
                              child: _buildDateTextField(hintText: 'MM'),
                            ),
                            const SizedBox(width: 10),
                            Expanded(
                              child: _buildDateTextField(hintText: 'DD'),
                            ),
                            const SizedBox(width: 10),
                            Expanded(
                              child: _buildDateTextField(hintText: 'YYYY'),
                            ),
                          ],
                        ),
                        const SizedBox(height: 40),
  ...
  Widget _buildDateTextField({required String hintText}) {
    return TextField(
